...
demand = json.loads((root / "fixtures" / "tool042_html_toc_reuse_demand.json").read_text(encoding="utf-8"))
...
assert result["selected_composition"] == "HTML2TEXT_THEN_MISTUNE_TOC_V1"
